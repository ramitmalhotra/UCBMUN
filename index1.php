...
<html>
    ...
    <body>
        <div id = "wrapper">
            <div id = "landing_cover">
                        ...
                        <div id = "landing_nav_item_container">
                            ...
                            <div class = "landing_nav_item" id = "conference_nav">
                                <div id = "conference_drop_container">
                                    ...
                                    <a target = "_blank" onclick= "javascript:document.location.href='venue.html'">
                                    ...
                                    <!--
                                    <a target = "_blank" onclick= "javascript:document.location.href='events.html'">
                                        <div class = "drop_item_container">
                                            <div class = "drop_item">
                                                Events
                                            </div>
                                    ...
                                    <a target = "_blank" onclick= "javascript:document.location.href='schedule.html'">
                                        <div class = "drop_item_container">
                                            <div class = "drop_item">
                                                Schedule
                                            </div>
                                    ...
                                    -->
                                    <a target = "_blank" onclick= "javascript:document.location.href='secretariat.html'">
                                        <div class = "drop_item_container">
                                            <div class = "drop_item">
                                                Secretariat
                                            </div>
                                    ...
                                    <a target = "_blank" onclick= "javascript:document.location.href='letter.html'">
                                        <div class = "drop_item_container">
                                            <div class = "drop_item">
                                                Welcome Letter
                                            </div>
                            ...
                            <a target = "_blank" onclick= "javascript:document.location.href='committees.html'"><div class = "landing_nav_item">
                                Committees
                            </div></a>
                            <!--
                            <a target = "_blank" onclick= "javascript:document.location.href='sponsors.html'">
                                <div class = "landing_nav_item">
                                    Sponsors
                                </div>
                            </a>
                            -->
                            <a target = "_blank" onclick= "javascript:document.location.href='contact.html'">
                                <div class = "landing_nav_item">
                                    Contact
                                </div>
                            </a>
                ...
                <div id = "landing_cover_content">
                    <div id = "landing_cover_header">
                        ...
                        <a target = "_blank" onclick= "javascript:document.location.href='registration.html'">
                    ...
                    <div id  = "landing_cover_img">
                        <img src = "assets/sftest3.png" class = "img_scaled_wh">
                    </div>
                </div>
            </div>
            ...
            <div id = "committees_page">
                ...
                <div id = "committees_content">
                    ...
                    <p id = "committees_content_desc">  
                        ...
                        Specialized Bodies and General Assembly, Crisis Committees, and, for the first time ever, Joint-Crisis Committees.
                    </p>
                     <a target = "_blank" onclick= "javascript:document.location.href='committees.html'"><div id = "committees_button" class = "button">
                        View Committees
                    </div></a>
                </div>
            </div>
            ...
            <div id = "sf_page_content">
                <div id = "sf_content">
                    ...
                    <div id = "sf_button" class = "button">
                        Explore SF
                    </div>
                </div>
                <div id = "sf_content_img">
                    <img src = "assets/sfoutline.png" class = "img_scaled_wh" id = "sf_img">
                </div>
                <div class = "clear">
                </div>
            </div>
                ...
                <div id = "staff_content">
                    ...
                    <p id = "staff_content_text">
                        ...
                        enjoy, learn, and excel at UCBMUN XIX.
                         ...
                         <a target = "_blank" onclick= "javascript:document.location.href='secretariat.html'"><div id = "staff_button" class = "button">
        ...
        <script type="text/javascript" src= "js/smoothscroll.js"></script><script type="text/javascript" src="http://code.jquery.com/jquery.min.js"></script>
