        ...
        <div id = "echr_page2">
            <div id = "echr_content">  
                ...
                <div id = "tabs_container">
                    <div id = "tabs_content">
                        <div class = "tab active" id = "tab1item">
                            Information
                        </div>
                        <div class = "tab" id = "tab2item">
                            Resources
                        </div>
                        <div class = "tab" id = "tab3item">
                            Assignments
                        </div>
                        <div class = "tab" id = "tab4item">
                            Position Papers
                        </div>
                        <!--<div class = "tab" id = "tab5item">
                            Office Hours
                        </div>-->
                        <div class = "clear">
                        </div>
                ...
                <div id = "info_content_container" class = "section tab1item">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="tab1">
                                        <div class="span6 offset1">
                                            <div class = "del_info_header" id = "first_header">REGISTRATION</div>
                                            <div class = "table_container">
                                                <table class="table table-striped">
                                                    <tbody>
                                                        <tr >
                                                            <td class = "desc" id = "first_desc">
                                                                <!--Deleted PHP-->
                                                            ...
                                                            <td class = "desc">
                                                                <!--Deleted PHP-->
                                                                <div class = "item_content"><?php echo $size; ?></div>
                                                                <br>
                                                                <div>Registered Delegates</div>
                                                            </td>
                                                            <td class = "desc">
                                                                <!--Deleted PHP-->
                                                                <div class = "item_content"><?php echo $date; ?></div>
                                                                <br>
                                            ...
                                            <div class = "del_info_header">FEES</div>
                                            <div class = "table_container">
                                                <table>
                                                    <tbody>
                                                        <tr>
                                                            <td class = "desc" id = "first_desc">
                                                                ...
                                                                <?php
                                                                    ...
                                                                    echo'<div class = "item_content">$'.$fee.'</div>'; 
                                                                ?>
                                                               <!-- </div>-->
                                                                <br>
                                                                <div>Per Delegate Fee</div>
                                                            </td>
                                                            <td class = "desc">
                                                                <!--Deleted PHP-->
                                                                <!--<div class = "item_content">-->
                                                                <?php
                                                                    ...
                                                                    echo'<div class = "item_content">$'.$totalDelegateFee.'</div>'; 
                                                                ?>
                                                                <!--</div>-->
                                                                <br>
                                                                <div>Total Delegates Fee</div>
                                                            </td>
                                                            <td class = "desc">
                                                                <!--Deleted PHP-->
                                                                <!--<div class = "item_content">-->
                                                                <?php
                                                                    ...
                                                                    echo "<div class = 'item_content'>$".$delegationFee."</div>";
                                                                ?>
                                                                <!--</div>-->
                                                                <br>
                                                                <div>Delegation Fee</div>
                                                            </td>
                                                            <td class = "desc">
                                                                <div class = "item_content"> &#36;0 </div>
                                                                <br>
                                                                <div>Faculty Advisor Fee</div>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                            <div class = "del_info_header">DUES & BALANCES</div>
                                            <div class = "table_container" id = "last">
                                                <table>
                                                    <tbody>
                                                        <tr >
                                                            <td class = "desc" id = "first_desc">
                                                                ...
                                                                <?php 
                                                                    ...
                                                                    echo "<div class = 'item_content'>$".$totalAmt."</div>"; 
                                                                ?>
                                                                <!--</div>-->
                                                                <br>
                                                                <div>Amount Due</div>
                                                            ...
                                                            <td class = "desc">
                                                                <!--<div class = "item_content">-->
                                                                <?php 
                                                                    echo "<div class = 'item_content'>$".$amountPaid."</div>"; 
                                                                ?>
                                                                <!--</div>-->
                                                                <br> 
                                                                <div>Amount Paid</div>
                                                            ...
                                                            <?php
                                                                ...
                                                                echo '<td class= "desc '.$class.'">';
                                                            ?>                                                            
                                                            <!--<td class = "desc .$class.">-->
                                                                <div class = "item_content">
                                                                    <?php 
                                                                        if ($balance < 0) {
                                                                            echo "<div class = 'item_content'>-$".abs($balance)."</div>"; 
                                                                        } 
                                                                        else {
                                                                            echo "<div class = 'item_content'>$".$balance."</div>";
                                                                        }
                                                                    ?>
                                                                </div>
                                                                <br>
                                                            ...
                                                            <!--<td>$".$balance."</td>-->
                                                               <td class = "desc">
                                                                ...
                                                                <?php 
                                                                    if ($proof == 0) {
                                                                        echo "<div class = 'item_content'> Pending </div>"; 
                                                                    } 
                                                                    else {
                                                                        echo "<div class = 'item_content'> Received </div>";  
                                                                    }
                                                                ?>
                                                                </div>
                                                                <br>
                ...
                <!-- Tab 2 -->
                <div id = "info_content_container"  class = "changewidth section hidden tab2item">
                    <div id = "info_content"> 
                        <div id = "subheader">
                            Delegate Resources
                        </div> 
                        <div class="tab-pane" id="tab2">
                            ...
                            <!--<center>
                            <iframe src="//player.vimeo.com/video/77835825" width="430" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen class = "iframe"></iframe>
                            <iframe src="//player.vimeo.com/video/77835825" width="430" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen class = "iframe"></iframe>
                            <iframe src="//player.vimeo.com/video/77835825" width="430" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen class = "iframe"></iframe>
                            <iframe src="//player.vimeo.com/video/77835825" width="430" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen class = "iframe"></iframe>
                            <iframe src="//player.vimeo.com/video/77835825" width="430" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen class = "iframe"></iframe>
                ...
                <!-- Tab 3 -->
                <div id = "info_content_container"  class = "changewidth section hidden tab3item">
                    <div id = "info_content"> 
                        <div id = "subheader">
                  ...
                  <!-- Tab 4 -->
                <div id = "info_content_container"  class = "changewidth section hidden tab4item">
                    <div id = "info_content"> 
                        <div id = "subheader">
                            Position Papers
                        </div>  
                 ...
                 <!-- Tab 5 
                    <div class="tab-pane tab5item  hidden section">
                        <center>
